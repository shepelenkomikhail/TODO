...
function getReactVersion() {
  const parts = React73.version.split(".");
  return {
    major: +parts[0],
    minor: +parts[1],
    patch: +parts[2]
...
var RTGTransition = React74.forwardRef((_ref, ref) => {
  let {
...
var Modal = (0, import_react55.forwardRef)((_ref, ref) => {
  ...
  let dialog = renderDialog ? renderDialog(dialogProps) : (0, import_jsx_runtime68.jsx)("div", Object.assign({}, dialogProps, {
    children: React76.cloneElement(children, {
      role: "document"
    })
  }));
...
var ModalBody = React77.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var ModalContext = React78.createContext({
...
var ModalDialog = React79.forwardRef(({
  bsPrefix,
  className,
  contentClassName,
  centered,
...
var ModalFooter = React80.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var AbstractModalHeader = React81.forwardRef(({
  closeLabel = "Close",
  closeVariant,
  closeButton = false,
  onHide,
...
var NavbarOffcanvas = React96.forwardRef((props, ref) => {
...
function createButton(name, defaultValue, label = name) {
  const Button3 = React108.forwardRef(({
    children,
    ...props
...
var ToastFade = React125.forwardRef((props, ref) => (0, import_jsx_runtime127.jsx)(Fade_default, {
  ...props,
  ref,
